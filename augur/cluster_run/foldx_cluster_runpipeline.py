...
def main(number_of_files):
    ...
    for num in range(int(number_of_files)):
        num += 1
        print("NUM: " + str(num))
        directory = os.getcwd() + "/multiple_runs_" + run_number + "/" + str(num) + "_foldx_split/"        print("Running feed_foldx.py for 1HA0_trimer... output to " + str(num) + "_1HA0_trimer_ddG_mutations.txt")
